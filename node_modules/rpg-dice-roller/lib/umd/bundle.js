...
(function (global, factory) {
  ...
  */
  ...
  var evaluate = function evaluate(equation) {
    return mathjsExpressionParser.eval(equation);
  };
  /**
  ...
  var minSymbol = Symbol('min-value');
  var maxSymbol = Symbol('max-value');
  /**
  ...
  var StandardDice = /*#__PURE__*/function () {
    ...
    function StandardDice(sides) {
      ...
      this[qtySymbol] = parseInt("".concat(qty), 10);
      ...
      this[maxSymbol] = max ? parseInt("".concat(max), 10) : sides;
    }
    /**
    ...
    _createClass(ResultGroup, [{
      ...
      set: function set(value) {
        if ((Array.isArray(value) || value instanceof Set) && _toConsumableArray(value).every(function (item) {
          ...
          this[modifiersSymbol$2] = new Set(_toConsumableArray(value));
        } else if (!value && value !== 0) {
          // clear the modifiers
  ...
  var MaxModifier = /*#__PURE__*/function (_Modifier) {
    ...
    _createClass(MaxModifier, [{
      ...
      set: function set(value) {
        ...
        this[maxSymbol$1] = parseFloat("".concat(value));
      }
      /* eslint-disable class-methods-use-this */
  ...
  var MinModifier = /*#__PURE__*/function (_Modifier) {
    ...
    _createClass(MinModifier, [{
      ...
      set: function set(value) {
        ...
        this[minSymbol$1] = parseFloat("".concat(value));
      }
      /* eslint-disable class-methods-use-this */
  ...
  var RollGroup = /*#__PURE__*/function () {
    ...
    _createClass(RollGroup, [{
      ...
      value: function roll() {
        ...
        (this.modifiers || []).forEach(function (modifier) {
          modifier.run(rollResults, _this);
        });
        return rollResults;
      }
      /**
      ...
      key: "expressions",
      get: function get() {
        return _toConsumableArray(this[expressionsSymbol] || []);
      }
      /**
      ...
      set: function set(expressions) {
        ...
        expressions.forEach(function (expression) {
          ...
          _this2[expressionsSymbol].push(expression);
        });
      }
      /**
      ...
      get: function get() {
        if (this[modifiersSymbol$3]) {
          // ensure modifiers are ordered correctly
          return new Map(_toConsumableArray(this[modifiersSymbol$3]).sort(function (a, b) {
            return a[1].order - b[1].order;
          }));
        }
  ...
  var DiceRoll = /*#__PURE__*/function () {
    ...
    function DiceRoll(notation) {
      ...
      if (notation instanceof Object && !Array.isArray(notation)) {
        ...
        this[expressionsSymbol$1] = Parser.parse(this.notation); // roll the dice
    ...
    _createClass(DiceRoll, [{
      ...
      value: function value(engine) {
        ...
        var results = new ResultGroup(this[expressionsSymbol$1].map(function (expression) {
      ...
      value: function value(rolls) {
        if (rolls instanceof ResultGroup) {
          ...
          this[rollsSymbol$1] = new ResultGroup(rolls.map(function (roll) {
      ...
      get: function get() {
        ...
        if (this.hasRolls()) {
          output += "".concat(this[rollsSymbol$1], " = ").concat(this.total);
        } else {
  ...
  exports.Modifiers = index$3;
  exports.NumberGenerator = NumberGenerator$1;
  exports.Parser = Parser;
  exports.Results = index$4;
